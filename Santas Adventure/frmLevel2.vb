Public Class frmLevel2
    ...
    Private Sub frmLevel2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'present location
        n(34).PictureBox1.Image = pctPresent.Image
        n(34).PictureBox1.Tag = 2
        n(30).PictureBox1.Image = pctPresent.Image
        n(30).PictureBox1.Tag = 2
        'left wall
        n(14).PictureBox1.Image = pctWall.Image
        n(14).PictureBox1.Tag = 1
        n(25).PictureBox1.Image = pctWall.Image
        ...
        'right wall
        'n(18).PictureBox1.Image = pctNotFloor.Image
        'n(18).PictureBox1.Tag = 1
        n(28).PictureBox1.Image = pctWall.Image
        n(28).PictureBox1.Tag = 1
        n(52).PictureBox1.Image = pctWall.Image
        n(52).PictureBox1.Tag = 1
        n(51).PictureBox1.Image = pctWall.Image
        n(51).PictureBox1.Tag = 1
        'low
        'n(49).PictureBox1.Image = pctNotFloor.Image
    ...
    Private Sub frmLevel2_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        If e.KeyCode = Keys.D Then
            ...
            If lblPresent.Text = 2 And lblTiles.Text = 33 Then
